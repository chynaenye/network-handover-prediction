...
from src.data_preprocess import data_strip_and_conversion, drop_unnecessary_columns, validate_ranges, handling_missing_values
...
def main():
    ...
    model_smote = train_model_smote(X_train_smote, y_train_smote, model=None) #Replace 'model=None' with your chosen model.
    
    # Train the model without SMOTE
    model = train_model(X_train_scaled, y_train, model=None) #Replace 'model=None' with your chosen model.
